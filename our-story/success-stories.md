...
*Last updated: 2026-09-20 16:38 UTC · thelake is a live on-chain bag, not a backtest.*
...
**Reflections earned since then:** **1,919.10 EASY** across **692** on-chain payments from `mon3y` (through 2026-09-20).

That is **+22.5% more EASY** from reflections alone (about **+31.3% APY** on quantity over 272 days), without selling. A later invite bonus of **100.00 EASY** sits in the wallet too. The comparison below ignores that bonus so the story stays “the original ~$100 bag.”

USD is a different lens. EASY itself moved from **$0.0120** to **$0.0179**. The comparable bag (day one + reflections) is **10,454.81 EASY**, about **$186.76** now: **+82.9%** vs those day-one dollars (**+125.0% APY** in USD).

| | |
| --- | --- |
| Account created | 2025-12-22 |
| Day-one stack | 8,535.71 EASY (**$102.10** at $0.0120) |
| Reflections (mon3y → thelake) | **1,919.10 EASY** (≈**$34.28** at today’s mark) |
| Reflection gain (EASY qty) | **+22.5% EASY** · **+31.3% APY** |
| USD bag vs day-one dollars | **+82.9%** · **+125.0% APY** |
| Reflection payments | 692 |
| Comparable bag | **10,454.81 EASY** (≈**$186.76**) |
| Wallet now | **10,554.81 EASY** (includes 100.00 invite EASY) |
...
| ---: | --- | --- | ---: | ---: | ---: |
| 1 | **EASY (thelake)** | Flex token | $186.76 | **+82.9%** | +125.0% |
| 2 | Morpho USDC | staked USDC | $105.45 | +3.3% | +4.4% |
| 3 | Spark USDC | staked USDC | $104.86 | +2.7% | +3.6% |
| 4 | Compound USDC | staked USDC | $104.72 | +2.6% | +3.5% |
| 5 | Aave USDC | staked USDC | $104.66 | +2.5% | +3.4% |
| 6 | USDC (idle) | stable | $102.08 | 0.0% | 0.0% |
| 7 | Bitcoin | blue chip | $93.80 | -8.1% | -10.8% |
| 8 | BNB | blue chip | $90.76 | -11.1% | -14.6% |
| 9 | Solana | blue chip | $89.60 | -12.2% | -16.1% |
| 10 | Ethereum | blue chip | $89.53 | -12.3% | -16.2% |
| 11 | XRP | blue chip | $75.79 | -25.8% | -33.0% |
| 12 | Polkadot | blue chip | $65.24 | -36.1% | -45.2% |
| 13 | Cardano | blue chip | $63.47 | -37.8% | -47.2% |
...
[`kinship1`](https://explorer.xprnetwork.org/account/kinship1) got **1,000.00 EASY** from `reflections` on **2025-11-27** (“When things seem hard, Take it EASY”). Since then it has taken **331.89 EASY** in reflections across **833** payments (≈**$5.93** at $0.0179), a **+33.2%** gain in EASY (≈**+42.3% APY** over 297 days). Balance now: **1,331.89 EASY** (≈**$23.79**).
