...
*Last updated: 2026-09-16 17:23 UTC · thelake is a live on-chain bag, not a backtest.*
...
**Reflections earned since then:** **1,906.39 EASY** across **685** on-chain payments from `mon3y` (through 2026-09-15).

That is **+22.3% more EASY** from reflections alone (about **+31.6% APY** on quantity over 268 days), without selling. A later invite bonus of **100.00 EASY** sits in the wallet too. The comparison below ignores that bonus so the story stays “the original ~$100 bag.”

USD is a different lens. EASY itself moved from **$0.0120** to **$0.0169**. The comparable bag (day one + reflections) is **10,442.10 EASY**, about **$176.89** now: **+73.3%** vs those day-one dollars (**+111.5% APY** in USD).

| | |
| --- | --- |
| Account created | 2025-12-22 |
| Day-one stack | 8,535.71 EASY (**$102.10** at $0.0120) |
| Reflections (mon3y → thelake) | **1,906.39 EASY** (≈**$32.29** at today’s mark) |
| Reflection gain (EASY qty) | **+22.3% EASY** · **+31.6% APY** |
| USD bag vs day-one dollars | **+73.3%** · **+111.5% APY** |
| Reflection payments | 685 |
| Comparable bag | **10,442.10 EASY** (≈**$176.89**) |
| Wallet now | **10,542.10 EASY** (includes 100.00 invite EASY) |
...
| ---: | --- | --- | ---: | ---: | ---: |
| 1 | **EASY (thelake)** | Flex token | $176.89 | **+73.3%** | +111.5% |
| 2 | Morpho USDC | staked USDC | $105.40 | +3.2% | +4.4% |
| 3 | Spark USDC | staked USDC | $104.82 | +2.7% | +3.6% |
| 4 | Compound USDC | staked USDC | $104.65 | +2.5% | +3.4% |
| 5 | Aave USDC | staked USDC | $104.62 | +2.5% | +3.4% |
| 6 | USDC (idle) | stable | $102.12 | 0.0% | 0.0% |
| 7 | Bitcoin | blue chip | $87.21 | -14.6% | -19.3% |
| 8 | BNB | blue chip | $84.82 | -16.9% | -22.3% |
| 9 | Ethereum | blue chip | $81.06 | -20.6% | -27.0% |
| 10 | Solana | blue chip | $78.69 | -22.9% | -29.9% |
| 11 | XRP | blue chip | $67.79 | -33.6% | -42.8% |
| 12 | Polkadot | blue chip | $55.91 | -45.2% | -56.0% |
| 13 | Cardano | blue chip | $52.82 | -48.3% | -59.3% |
...
[`kinship1`](https://explorer.xprnetwork.org/account/kinship1) got **1,000.00 EASY** from `reflections` on **2025-11-27** (“When things seem hard, Take it EASY”). Since then it has taken **330.44 EASY** in reflections across **827** payments (≈**$5.60** at $0.0169), a **+33.0%** gain in EASY (≈**+42.7% APY** over 293 days). Balance now: **1,330.44 EASY** (≈**$22.54**).
